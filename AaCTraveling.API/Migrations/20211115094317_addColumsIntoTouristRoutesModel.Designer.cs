...
namespace AaCTraveling.API.Migrations
{
    ...
    [Migration("20211115094317_addColumsIntoTouristRoutesModel")]
    partial class addColumsIntoTouristRoutesModel
    {
            ...
            modelBuilder.Entity("AaCTraveling.API.Models.TouristRoute", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("29f8d5a9-14f7-4513-9239-e6816ea7602c"),
                            CreateTime = new DateTime(2021, 11, 15, 9, 43, 17, 248, DateTimeKind.Utc).AddTicks(5315),
